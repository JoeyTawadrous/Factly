...
class Settings: UITableViewController, UITextFieldDelegate, MFMailComposeViewControllerDelegate {
	...
	@IBAction func backButtonPressed() {
		Utils.presentView(self, viewName: Constants.Views.FACT)
	}
	...
	@IBAction func shareButtonPressed() {
		Utils.openShareView(viewController: self, fact: "In Shakespeare's play Julius Caesar, Caesar's last words were... Et tu, Brute?")
	}
